...
ControlInterfaceSameMethod = function(_Interface1, _Interface2)
{
...
OverrideInterface = function(_OriginalClass, _Overrides)
{
    if (_Overrides)
    {
...
Override = function(_OriginalClass, _Overrides)
{
    if (_Overrides)
    {
